...
from losses.crossmodalcontrastive_loss import CrossModalContrastiveLoss, CosineDecorrelateLoss
...
def build_losses(config, num_train_clothes):
    ...
    crossmodal_contra = CrossModalContrastiveLoss(temperature=0.07, symmetric=True)
    CosineDecorrelate = CosineDecorrelateLoss()


    return criterion_cla, criterion_pair, criterion_clothes, criterion_cal, CosineDecorrelate
