...
# For CCVID dataset
# python -m torch.distributed.run  --nproc_per_node=1 --master_port 12345 main.py --dataset ccvid --cfg configs/c2dres50_ce_cal.yaml 
CUDA_VISIBLE_DEVICES=0 python main.py --dataset ccvid --cfg configs/c2dres50_ce_cal.yaml