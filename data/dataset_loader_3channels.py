...
class VideoDataset(Dataset):
    ...
    def __init__(self, 
        ...
        self.event_path  = '/root/mxh/event_data/CCVID'
    ...
    def __getitem__(self, index):
        ...
        if self.temporal_transform is not None:
            ...
            # print(img_paths)
        new_paths = [
            os.path.join(self.event_path, os.path.splitext(p.split('CCVID/')[-1])[0] + '.png')
            for p in img_paths
                    ]
        # print(new_paths[0])
        ...
        if self.spatial_transform is not None:
            ...
            clip_event = [self.spatial_transform(event) for event in clip_event] 
